function out=pkfnd_mod(im,th,szmax,sz)
...
% SZ-> 14/09/2016 szmax is a way of getting rid of too big bjects.
...
negative=bwareaopen(above,szmax); %SZ ->This will leave the objects of area BIGGER than 
positive=ones(size(above))-negative; 
...
if n==0
    ...
    %display('Dots above the threshold:');
    %n
end
mx=[];
